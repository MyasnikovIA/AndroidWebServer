package ru.sgk.webserver.AndroidLib;
...
import ru.sgk.webserver.Lib.SimpleFileDialog;
import ru.sgk.webserver.Lib.Sys;
import ru.sgk.webserver.MainActivity;
import ru.sgk.webserver.services.ServiceExample;
...
public void ShowDialogDir(String SelectDir){
    MainActivity.chooseFile( parentActivity , SelectDir);
    ...
    /*
    SimpleFileDialog FolderChooseDialog =  new SimpleFileDialog(parentActivity, "FolderChoose",
            new SimpleFileDialog.SimpleFileDialogListener()
            {
                ...
                public void onChosenDir(String chosenDir)
                {
                    ...
                    m_chosen = chosenDir;
                    Toast.makeText(parentActivity, "Chosen FileOpenDialog File: " +
                            m_chosen, Toast.LENGTH_LONG).show();
                }
            });
    FolderChooseDialog.chooseFile_or_Dir(SelectDir);


   /*
    SimpleFileDialog FileOpenDialog =  new SimpleFileDialog(parentActivity, "FileOpen",
            new SimpleFileDialog.SimpleFileDialogListener()
            {
                @Override
                public void onChosenDir(String chosenDir)
                {
                    // The code in this function will be executed when the dialog OK button is pushed
                    m_chosen = chosenDir;
                    Toast.makeText(parentActivity, "Chosen FileOpenDialog File: " + m_chosen, Toast.LENGTH_LONG).show();
                }
            });
    //You can change the default filename using the public variable "Default_File_Name"
    FileOpenDialog.Default_File_Name = SelectDir;
    FileOpenDialog.chooseFile_or_Dir(SelectDir);
  */
}


    private void SelectFile(String SelectDir) {
       MainActivity.chooseFile( parentActivity , SelectDir);
    }
